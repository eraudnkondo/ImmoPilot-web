...
import { 
  FaHome, FaMapMarkerAlt, FaImages, FaEuroSign, 
...
const GestionBiens = () => {
  const features = [
    ...
    },
    {
      ...
      description:
        "Géolocalisez chaque bien sur une carte interactive et visualisez les quartiers, commodités à proximité.",
    },
    {
    ...
    },
    {
      ...
      description:
        "Consultez les revenus locatifs, charges, taxes et amortissements pour chaque bien, et visualisez la rentabilité.",
    },
    {
      icon: <FaRuler className="text-[#8A9BFF] text-3xl" />,
      title: "Caractéristiques techniques",
      description:
        "Stockez les surfaces (habitable, terrain), diagnostics (DPE, amiante, plomb), et documents associés.",
    },
    {
      icon: <FaCalendarAlt className="text-[#8A9BFF] text-3xl" />,
      title: "Historique et travaux",
      description:
        "Gardez une trace des travaux effectués, des dates d'achat/vente, et des évolutions de valeur.",
    },
  ];
      ...
      <section className="relative bg-gradient-to-br from-[#8A9BFF] to-[#6F8BFF] text-white py-20 px-6 overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto text-center relative z-10">
          ...
          <p className="text-xl md:text-2xl max-w-3xl mx-auto mb-10">
            Centralisez toutes les informations de vos propriétés : fiches détaillées, photos, 
            documents techniques, suivi financier et historique. Une vision claire pour mieux gérer.
          </p>
      ...
      <section className="bg-gray-100 py-16 px-6">
        <div className="max-w-7xl mx-auto">
          ...
          <p className="text-center text-gray-600 max-w-2xl mx-auto mb-12">
            Des outils simples et complets pour ne rien oublier et optimiser la valeur de votre patrimoine.
          </p>
      ...
      <section className="bg-[#8A9BFF] py-20 px-6">
        <div className="max-w-4xl mx-auto text-center text-white">
          ...
          <p className="text-xl mb-10 opacity-90">
            Créez votre compte gratuitement et commencez à gérer votre patrimoine en quelques clics.
          </p>
          <Link
            to="/inscription"
